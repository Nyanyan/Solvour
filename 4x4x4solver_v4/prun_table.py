...
solved = Cube()
print('phase 1 2/2')
prunning = [[99 for _ in range(8388608)] for _ in range(2)]
solved_idx = idx_ep_phase1(solved.Ep)
prunning[0][solved_idx] = 0
...
while que:
    ...
    for twist in successor[1]:
        ...
        n_idx = idx_ep_phase1(n_puzzle)
        parity = ep_switch_parity(n_puzzle)
        if prunning[parity][n_idx] > num + 1:
            prunning[parity][n_idx] = num + 1
            que.append([n_puzzle, num + 1, twist, l1_twist, l2_twist])
